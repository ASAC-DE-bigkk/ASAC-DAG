...
def test_derived_column_description_is_published():
    ...
    col_rows, _ext, _pats, _disp, _params = _handoff_rows(Serve(*SPEC_ARGS), meta, COL_DEFS, "pub1")
...
def test_missing_declaration_stays_empty_not_invented():
    ...
    col_rows, _ext, _pats, _disp, _params = _handoff_rows(Serve(*SPEC_ARGS), {"columns": {}}, COL_DEFS, "pub1")
...
def test_gold_declaration_wins_over_nothing_and_derived_never_overwrites_it():
    ...
    col_rows, _ext, _pats, _disp, _params = _handoff_rows(
...
def test_handoff_uses_public_rollup_primary_key_when_declared():
    ...
    _cols, ext, _patterns, _disp, _params = _handoff_rows(

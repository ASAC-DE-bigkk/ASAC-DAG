...
TRAFFIC_CORE_GOLD_PUBLICATION_READY_ASSET = "iceberg://traffic/gold/core-publication-ready"
TRAFFIC_CROSS_DOMAIN_GOLD_PUBLICATION_READY_ASSET = (
    "iceberg://traffic/gold/cross-domain-publication-ready"
)
# Keep the historical name as a compatibility alias for code that only knows
# the Traffic-owned terminal asset.  New DAGs use the explicit names above.
TRAFFIC_GOLD_PUBLICATION_READY_ASSET = TRAFFIC_CORE_GOLD_PUBLICATION_READY_ASSET
...
TRAFFIC_CORE_PUBLICATION_PRODUCT_IDS = TRAFFIC_FLOW_PUBLICATION_PRODUCT_IDS
TRAFFIC_CROSS_DOMAIN_PUBLICATION_PRODUCT_IDS = TRAFFIC_INCIDENT_PUBLICATION_PRODUCT_IDS
...
TRAFFIC_CORE_GOLD_PUBLICATION_READY_ASSET_REF = Asset(
    TRAFFIC_CORE_GOLD_PUBLICATION_READY_ASSET
)
TRAFFIC_CROSS_DOMAIN_GOLD_PUBLICATION_READY_ASSET_REF = Asset(
    TRAFFIC_CROSS_DOMAIN_GOLD_PUBLICATION_READY_ASSET
)
TRAFFIC_GOLD_PUBLICATION_READY_ASSET_REF = TRAFFIC_CORE_GOLD_PUBLICATION_READY_ASSET_REF

...
def test_incident_slot_floors_logical_date_to_five_minutes_in_utc():
    slot = traffic_incident_slot(
        datetime(2026, 8, 8, 9, 7, tzinfo=KST),
    ...
    assert slot.recovery_boundary != "raw_retention_not_declared"


def test_incident_slot_accepts_iso_timestamp_and_rejects_naive_time():
    assert traffic_incident_slot(
        "2026-08-08T00:09:00+00:00",
        recovery_boundary="2026-08-01T00:00:00+00:00",
    ).collection_slot_at == (

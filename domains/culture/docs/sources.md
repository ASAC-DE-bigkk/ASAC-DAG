...
culture가 채택한 **14개 데이터셋**(KOPIS 6 + 서울 열린데이터 6 + KOBIS 2). 레지스트리 원본:
...
| 13 | `kobis_boxoffice_nation` | kobis | kobis_boxoffice | `searchDailyBoxOfficeList` | snapshot_append | KOBIS 일별 박스오피스 — 전국 | movieCd, movieNm |
| 14 | `kobis_boxoffice_seoul` | kobis | kobis_boxoffice | `searchDailyBoxOfficeList` | snapshot_append | KOBIS 일별 박스오피스 — 서울(wideAreaCd) | movieCd, movieNm |
